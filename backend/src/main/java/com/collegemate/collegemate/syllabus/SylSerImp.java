    ...
    public Syllabus generateAndSaveSyllabus(String syllabusText) {
        ...
        String prompt = """
            ...
            2. FALLBACK QUERIES REQUIRED: Because exact URLs may break or result in 404s, you MUST provide a `fallbackQueryUrl` for EVERY resource. 
               - For VIDEO: The fallback must be a fully formed YouTube search URL (e.g., [https://www.youtube.com/results?search_query=Your+Topic+Here](https://www.youtube.com/results?search_query=Your+Topic+Here)).
               - For ARTICLE: The fallback must be a fully formed Google search URL targeting reputable sites (e.g., [https://www.google.com/search?q=site:geeksforgeeks.org+OR+site:javatpoint.com+Your+Topic+Here](https://www.google.com/search?q=site:geeksforgeeks.org+OR+site:javatpoint.com+Your+Topic+Here)).
